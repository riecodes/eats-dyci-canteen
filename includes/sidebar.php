...
<nav class="sidebar flex-shrink-0 p-3 text-secondary">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        <?php if ($role === 'admin'): ?>
            ...
            <li class="nav-item"><a href="index.php?page=admin_dashboard" class="nav-link <?php echo ($_GET['page'] ?? 'dashboard') === 'dashboard' ? 'active' : ''; ?>"><i class="fas fa-tachometer-alt me-2" style="color:#170e63;"></i>Dashboard</a></li>

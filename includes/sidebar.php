...
<nav class="sidebar flex-shrink-0 p-3 text-secondary">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        <?php if ($role === 'admin'): ?>
            ...
            <li class="nav-item"><a href="index.php?page=admin_dashboard" class="nav-link <?php echo ($_GET['page'] ?? 'dashboard') === 'dashboard' ? 'active' : ''; ?>"><i class="fas fa-tachometer-alt me-2 sidebar-icon-admin"></i>Dashboard</a></li>
            ...
            <li><a href="index.php?page=admin_announcements" class="nav-link <?php echo ($_GET['page'] ?? '') === 'admin_announcements' ? 'active' : ''; ?>"><i class="fas fa-bullhorn me-2 sidebar-icon-admin"></i>Announcements</a></li>
        ...
        <?php elseif ($role === 'seller'): ?>
            ...
            <li><a href="index.php?page=seller_orders" class="nav-link <?php echo ($_GET['page'] ?? '') === 'seller_orders' ? 'active' : ''; ?>"><i class="fas fa-receipt me-2 sidebar-icon-seller"></i>Orders</a></li>
            <li><a href="index.php?page=seller_announcements" class="nav-link <?php echo ($_GET['page'] ?? '') === 'seller_announcements' ? 'active' : ''; ?>"><i class="fas fa-bullhorn me-2 sidebar-icon-seller"></i>Announcements</a></li>
        ...
        <?php elseif ($role === 'buyer'): ?>
            ...
            <li><a href="index.php?page=buyer_announcements" class="nav-link <?php echo ($_GET['page'] ?? '') === 'buyer_announcements' ? 'active' : ''; ?>"><i class="fas fa-bullhorn me-2 sidebar-icon-buyer"></i>Announcements</a></li>

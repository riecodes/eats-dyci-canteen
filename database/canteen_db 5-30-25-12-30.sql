...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2025 at 06:34 PM
...
(2, NULL, '1', '1', 30.00, '../assets/imgs/products_68364dd74b22e.jpg', 1, 3, 0);
...
INSERT INTO `stalls` (`id`, `name`, `description`, `seller_id`, `canteen_id`) VALUES
(3, 'burger king stall 1', 'burger', 3, 1);
...
(1, 'Admin', 'a@gmail.com', '$2y$10$oxeXOZcU5sSfIYkzZjtBEuxgbMNC6muwa0crfr.R1JvP5lG5WeVzS', 'admin', '2025-05-27 04:37:18', NULL),
(3, 'ss', 's@gmail.com', '$2y$10$4S7TyUPCp/VKPQAQ3Dy9a.Whwef8yRWkVwrzj..03N0/8vwZBpPC2', 'seller', '2025-05-27 22:56:27', '../assets/imgs/qr_seller_3.jpg'),
(5, 'buy', 'b@gmail.com', '$2y$10$arjdYcQ.35QKUAJZz/zXH.YuJJfEKxYZPmc8Ld66gETgwq0XQhqKq', 'buyer', '2025-05-27 22:57:13', NULL);
...
ALTER TABLE `order_items`
  ...
  ADD CONSTRAINT `order_items_ibfk_2` FOREIGN KEY (`food_id`) REFERENCES `products` (`id`) ON DELETE CASCADE;
